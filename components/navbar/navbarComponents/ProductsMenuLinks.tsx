...
function ProductsMenuLinks() {
  return (
    <div className='products_menu'>
      <a
            href="/"
            className="menu_link p-3 mb-3 block rounded-lg z-0 bg-appBgPurple relative w-full none overflow-hidden text-white "
          >
            <svg
              width="40"
              height="40"
          ...
          <a
            href="/"
            className="menu_link p-4 block rounded-lg z-0 bg-ghoBgGreen relative w-full none overflow-hidden text-white "
          >
            <svg
              width="40"
              height="40"
...
export default ProductsMenuLinks
